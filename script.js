document.addEventListener('DOMContentLoaded', () => {
    ...
    let spieler = [
        ...
        { name: 'Leo', punkte: [3, 3, 0, 0, 0, 5, 0] }, 
        { name: 'Mika', punkte: [3, 0, 2, 0, 2, 5, 0] }, 
        { name: 'Mike', punkte: [3, 2, 3, 0, 4, 1, 2] },
        { name: 'Max', punkte: [0, 0, 1, 2, 2, 4, 0] },
        { name: 'Der Tobi', punkte: [0, 4, 2, 2, 3, 4, 0] },
        { name: 'Reisbällchen', punkte: [5, 0, 3, 0, 2, 3, 0] },
        { name: 'Ruben', punkte: [0, 0, 1, 0, 4, 0, 0] },
        { name: 'Lucas', punkte: [0, 1, 2, 1, 0, 2, 0] },
        { name: 'Jul', punkte: [0, 2, 0, 5, 3, 2, 0] },
        { name: 'Robert S.', punkte: [0, 4, 0, 0, 0, 3, 0] },
        { name: 'Arian', punkte: [0, 0, 1, 0, 5, 0, 0] },
        { name: 'Lennox', punkte: [0, 0, 3, 3, 4, 3, 0] },
        { name: 'Henrik', punkte: [0, 0, 1, 0, 0, 4, 0] },
        { name: 'Robert M.', punkte: [0, 0, 5, 0, 0, 0, 0] }
    ];
