document.addEventListener('DOMContentLoaded', () => {
    ...
    let spieler = [
        ...
        { name: 'Leo', punkte: [3, 3, 0, 0, 0, 5] }, 
        { name: 'Mika', punkte: [3, 0, 2, 0, 2, 5] }, 
        { name: 'Mike', punkte: [3, 2, 3, 0, 4, 1] },
        { name: 'Max', punkte: [0, 0, 1, 2, 2, 4] },
        { name: 'Der Tobi', punkte: [0, 4, 2, 2, 3, 4] },
        { name: 'Reisbällchen', punkte: [5, 0, 3, 0, 2, 3] },
        { name: 'Ruben', punkte: [0, 0, 1, 0, 4, 0] },
        { name: 'Lucas', punkte: [0, 1, 2, 1, 0, 2] },
        { name: 'Jul', punkte: [0, 2, 0, 5, 3, 2] },
        { name: 'Robert S.', punkte: [0, 4, 0, 0, 0, 3] },
        { name: 'Arian', punkte: [0, 0, 1, 0, 5, 0] },
        { name: 'Lennox', punkte: [0, 0, 3, 3, 4, 3] },
        { name: 'Henrik', punkte: [0, 0, 1, 0, 0, 4] },
        { name: 'Robert M.', punkte: [0, 0, 5, 0, 0, 0] }
    ];
